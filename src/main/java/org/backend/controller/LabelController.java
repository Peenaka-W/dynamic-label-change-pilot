...
//     * @param labelKey the key of the label
//     * @param request the personalization request
//     * @return ResponseEntity with the updated label DTO
//     */
//    @PostMapping("/{moduleName}/{tenantId}/{screenName}/labels/{labelKey}")
//    public ResponseEntity<LabelDto> updateLabelPersonalization(
//            @PathVariable String moduleName,
//            @PathVariable String tenantId,
//            @PathVariable String screenName,
//            @PathVariable String labelKey,
//            @Valid @RequestBody LabelPersonalizationRequest request) {
//
//        LabelDto updatedLabel = labelService.updateLabelPersonalization(
//                moduleName, tenantId, screenName, labelKey, request);
//
//        return new ResponseEntity<>(updatedLabel, HttpStatus.OK);
//    }
//
//    /**
//     * Update a label personalization using request body for all parameters.
//     *
//     * @param request the personalization request containing all parameters
//     * @return ResponseEntity with the updated label DTO
//     */
//    @PostMapping("/labels/personalize")
//    public ResponseEntity<LabelDto> updateLabelPersonalization(
//            @Valid @RequestBody LabelPersonalizationFullRequest request) {
//
//        LabelDto updatedLabel = labelService.updateLabelPersonalization(
//                request.getModuleName(),
//                request.getTenantId(),
